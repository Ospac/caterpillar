...
/**
 * Renders an SVG grid guide overlay sized to the provided stage.
 *
 * The overlay fills the stage area with a repeating cell pattern that applies a stroked cell outline and a subtle noise displacement for texture. The SVG is non-interactive and marked aria-hidden.
 *
 * @param stage - Grid stage used to compute the overlay's pixel size
 * @returns The SVG element representing the grid guide overlay
 */
